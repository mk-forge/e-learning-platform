        ...
        async function fetchCourseDetail() {
            try {
                ...
                if (session && session.user?.email) {
                    ...
                    const isUserEnrolled = userData.enrollments.some((enrollment: {
                        courseId: number
                ...
                <div className="relative h-64 md:h-96">
                    ...
                    <div
                        ...
                        <div className="mb-2">
                            {course.isPremium && (
                                <span
                                    className="bg-yellow-500 text-white text-xs font-bold px-3 py-1 rounded-full mr-2 uppercase tracking-wide">
                                    Premium
                                </span>
                            )}
                            {!course.hasAds && (
